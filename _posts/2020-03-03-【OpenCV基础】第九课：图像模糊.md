...
⚠️使用该操作的原因之一就为了给图像预处理时候降低噪声。

图像模糊操作背后是数学的卷积计算。

>卷积操作的原理：
>
>![](https://github.com/x-jeff/BlogImage/raw/master/OpenCVSeries/Lesson9/9x1.gif)
...
>
>![](https://github.com/x-jeff/BlogImage/raw/master/OpenCVSeries/Lesson9/9x2.png)
>
...
![](https://github.com/x-jeff/BlogImage/raw/master/OpenCVSeries/Lesson9/9x3.png)
...
在高斯模糊中，二维高斯分布公式中的$x_1,x_2$对应的一个点的x,y坐标。因此可以假设$x_1,x_2$是相互独立的，所以：
...
![](https://github.com/x-jeff/BlogImage/raw/master/OpenCVSeries/Lesson9/9x5.png)
...
![](https://github.com/x-jeff/BlogImage/raw/master/OpenCVSeries/Lesson9/9x6.png)

这9个点的权重总和不等于1，所以需要对其进行归一化处理：每个格子的数除以所有格子的数加起来的总和。这样即可得到一个$3\times 3$的高斯掩膜：

![](https://github.com/x-jeff/BlogImage/raw/master/OpenCVSeries/Lesson9/9x7.png)
...
如果$\sigma$较小（其二维高斯分布密度函数图像见下图右），那么生成的掩膜的中心系数较大，而周围的系数较小，这样对图像的模糊效果就不是很明显；反之，$\sigma$较大（其二维高斯分布密度函数图像见下图左），则生成的模版的各个系数相差就不是很大，比较类似均值模糊，对图像的模糊效果比较明显。

![](https://github.com/x-jeff/BlogImage/raw/master/OpenCVSeries/Lesson9/9x8.png)
...
![](https://github.com/x-jeff/BlogImage/raw/master/OpenCVSeries/Lesson9/9x9.png)
...
![](https://github.com/x-jeff/BlogImage/raw/master/OpenCVSeries/Lesson9/9x10.png)
...
其中，$f(x,y)$表示图像在点$(x,y)$处的像素值；$(k,l)$为模版窗口的中心坐标；$(i,j)$为模版窗口的其他系数的坐标；$\sigma_r^2$为高斯函数的标准差。
...
![](https://github.com/x-jeff/BlogImage/raw/master/OpenCVSeries/Lesson9/9x11.png)
...
![](https://github.com/x-jeff/BlogImage/raw/master/OpenCVSeries/Lesson9/9x12.png)
...
👉**高纬高斯分布**的[概率密度函数](http://shichaoxin.com/2019/10/23/数学基础-第八课-概率分布/)为：
...
![](https://github.com/x-jeff/BlogImage/raw/master/OpenCVSeries/Lesson9/9x4.png)
